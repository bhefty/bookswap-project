        ...
        {props.searchResults.map((book) => {
          return (
            <BookCard
              ...
              book={book}
              action={{
                handleAction: () => props.handlePrimaryAction(book),
                handleAdditionalAction: () => props.handleSecondaryAction(book),
                actionText: props.actionText,
                primaryButtonClass: props.primaryButtonClass,
                actionAdditionalText: props.actionSecondaryText,
...
SearchForm.propTypes = {
  ...
  actionSecondaryText: PropTypes.string,
